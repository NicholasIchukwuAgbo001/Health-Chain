...
const initialRecords: MedicalRecord[] = [
  {
    ...
    prescription: [
      { medication: "Lisinopril", dosage: "10mg daily", duration: "Ongoing" },
    ],
    vitalSigns: {
      ...
      <div className="p-6 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900 border-b border-lightgrey pb-2">
              Record Information
            </h3>
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-gray-900">
                  {getPatientName(record.patientId)} ({record.patientId})
                </p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-500">
        ...
        {record.diagnosis && (
          <div>
            <h3 className="text-lg font-semibold text-gray-900 border-b border-lightgrey pb-2 mb-4">
              Diagnosis
            </h3>
        ...
        {record.treatment && (
          <div>
            ...
            <p className="text-gray-900 bg-green-50 p-4 rounded-lg">
              {record.treatment}
            </p>
          </div>
        )}
...
const MedicalRecords: React.FC = () => {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            This page is only accessible to hospital staff.
          </p>
        </div>
      </div>
    );
  ...
  const filteredRecords = records.filter((record) => {
    ...
    const matchesType =
      !selectedRecordType || record.recordType === selectedRecordType;
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
          ...
          <div>
            <p className="text-gray-600 mt-2">
              This record is manages on blockchain verification
            </p>
          </div>
        </div>
